...
Java_com_bill_mei_1utils_rtmp_RtmpHelper_init(JNIEnv *env, jclass type, jstring url_, jint w, jint h,
                                         jint timeOut) {
...
Java_com_bill_mei_1utils_rtmp_RtmpHelper_sendSpsAndPps(JNIEnv *env, jclass type, jlong cptr,
...
JNIEXPORT jint JNICALL
Java_com_bill_mei_1utils_rtmp_RtmpHelper_sendVideoData(JNIEnv *env, jclass type, jlong cptr,
...
JNIEXPORT jint JNICALL
Java_com_bill_mei_1utils_rtmp_RtmpHelper_sendAacSpec(JNIEnv *env, jclass type, jlong cptr,
...
JNIEXPORT jint JNICALL
Java_com_bill_mei_1utils_rtmp_RtmpHelper_sendAacData(JNIEnv *env, jclass type, jlong cptr,
                                                jbyteArray data_, jint len, jlong timestamp) {
    jbyte *data = env->GetByteArrayElements(data_, NULL);
